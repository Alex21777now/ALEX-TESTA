                ...
                <div className="grid_12">
                    <div id="constructor" className="constructor-block">
                        <div className="cb-top-line">
                            ...
                            <div className="cb-step cb-step--current" data-step="cb-item3" id="cb-step3">
                                <p>
                                    <span>3</span>
                                    Заголовок
                                </p>
                        ...
                        <div className="cb-wrapper">
                            <div id="cb-items" className="cb-item3">
                        ...
                        {/*  <span id="ariston" className="btn-font btn-font--active">
                          ...
                          <button id="ariston" className="btn-font btn-font--active">
                              Ariston
                            </button>
                                          <button id="davinci" className="btn-font">
                              DaVinci
                            </button>
                                          <button id="brody" className="btn-font">
                              Brody
                            </button>
                                    </div>
                                </div>
