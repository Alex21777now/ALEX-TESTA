...
export default function Layout_1() {
  ...
  const [text2, setText2] = React.useState(<img src="./img/pics/01.jpg" alt="Картинка №1" title="Картинка №1" width="176"
       height="220" />);
                ...
                <div className="grid_12">
                    <div id="constructor" className="constructor-block">
                        <div className="cb-top-line">
                            <div className="cb-step cb-step--current" data-step="cb-item1" id="cb-step1">
                                <p>
                                    <span>1</span>
                                    Изображение
                                </p>
                            ...
                            <a href="/about">
                            <div className="cb-step" data-step="cb-item2" id="cb-step2">
                                <p>
                                    <span>2</span>
                                    Рама
                                </p>
                        ...
                        <div className="cb-result">
                            ...
                            <div className="cb-result__bottom">
                                ...
                                <a className="cb-next" href="/about">Далее
                        ...
                        <div className="cb-wrapper">
                            <div id="cb-items" className="cb-item1">
                                <div className="cb-item">
                                    ...
                                    <div className="cb-item-pics">
                                        ...
                                        <div className="cb-item-pic" onClick={moveText}>
